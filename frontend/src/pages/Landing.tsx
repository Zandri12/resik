  ...
  return (
    <div className="bg-surface text-on-surface font-body">
      ...
      <header className="pt-safe-header sticky top-0 z-50 border-b border-outline-variant/20 bg-surface/80 backdrop-blur-lg">
        <div className="mx-auto flex h-20 max-w-7xl items-center px-4 sm:px-6 lg:px-10">
          <ClickSpark
            sparkColor="#005160"
            sparkSize={10}
            sparkRadius={15}
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-2 sm:gap-4">
              <button
                ...
                className="material-symbols-outlined flex h-11 w-11 items-center justify-center rounded-lg text-on-surface hover:bg-surface-container-high md:hidden"
              ...
              <Link
                to="/login"
                className="rounded-lg bg-primary px-4 py-2.5 text-xs font-bold text-on-primary shadow-sm transition-all hover:opacity-90 sm:px-6 sm:text-sm"
              >
                Pesan Sekarang
              </Link>
            </div>
      ...
      <main>
        ...
        >
        {/* Hero */}
        <section className="relative overflow-hidden bg-surface pt-16 pb-24 lg:pt-24 lg:pb-32">
            ...
            <div className="relative z-10">
              ...
              <h1 className="mb-8 font-headline">
                <SplitText
                  text="Cucian Bersih,"
                  tag="span"
                  className="block text-5xl lg:text-7xl font-extrabold text-on-surface leading-[1.2]"
                  textAlign="left"
                  delay={50}
                  duration={1.25}
                  ease="power3.out"
                ...
                <span className="inline-flex max-w-full flex-wrap items-baseline gap-x-[0.25em]">
                  <SplitText
                    text="Hidup Lebih"
                    tag="span"
                    className="inline-block shrink-0 text-5xl lg:text-7xl font-extrabold text-on-surface leading-[1.28]"
                    textAlign="left"
                    delay={50}
                    duration={1.25}
                    ease="power3.out"
                  ...
                  <ShinyText
                    ...
                    pauseOnHover={false}
                    disabled={false}
                    className="shrink-0 text-5xl lg:text-7xl font-extrabold font-headline leading-[1.28]"
                  />
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/login"
                  className="bg-gradient-to-br from-primary to-primary-container text-on-primary px-10 py-4 rounded-xl font-bold text-lg shadow-lg hover:scale-[1.02] transition-transform flex items-center justify-center gap-2"
                >
                  Pesan Sekarang
                ...
                <a
                  href="#harga"
                  className="bg-surface-container-lowest text-primary px-10 py-4 rounded-xl font-bold text-lg hover:bg-surface-container-low transition-colors flex items-center justify-center gap-2 border border-outline-variant/30"
                >
                  Lihat Harga
                </a>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden aspect-[4/5] shadow-2xl">
                <img
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuDeiL_W-W2HUxie-UNvg1zC6rU-JL71oDR69R4UG5yhbUa5Xzd3UNxNLgeOsJIsYaorFapeqBJBCxSkDSwM89FL0twR9e45OT90Hy0XSy1bV3pz2uBva0VT88Skz2ituGefL6CXDceXygh3xee5NkWFeY53GEpUIb632J3uL2dqRY1N8J6ZDkVwkG7Hli9YD1zVypr02GMggKsYSWGTUqDeoU2u0VcKVq1gZ1ZBQp-_pOxzArOhDgC9AH_GVTY9-I2tN_dB6x4lzb4"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-primary/20 to-transparent" />
              </div>
              <div className="absolute -bottom-6 -left-6 bg-surface-container-lowest p-6 rounded-2xl shadow-xl flex items-center gap-4 border border-outline-variant/20">
          ...
          <section className="py-16 lg:py-20 bg-surface-container-low border-y border-outline-variant/15" id="promo-info">
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
              <div className="text-center mb-12 max-w-2xl mx-auto">
                ...
                <h2 className="text-3xl lg:text-4xl font-extrabold text-on-surface font-headline tracking-tight">
                  Promo &amp; info terbaru
                </h2>
              ...
              <div className="relative mt-10 w-full max-w-7xl mx-auto px-12 sm:px-14 lg:px-16">
                <Carousel
                  opts={{
                    align: 'start',
                ...
                >
                  ...
                  <CarouselPrevious
                    variant="outline"
                    className="left-0 sm:left-1 top-[42%] -translate-y-1/2 size-9 border-outline-variant/50 bg-surface-container-lowest/95 shadow-md"
                  />
                  <CarouselNext
                    variant="outline"
                    className="right-0 sm:right-1 top-[42%] -translate-y-1/2 size-9 border-outline-variant/50 bg-surface-container-lowest/95 shadow-md"
                  />
                </Carousel>
                {landingBlocks.length > 1 ? (
                  <p className="text-center text-xs text-on-surface-variant mt-5 md:hidden">
                    Geser kartu atau tap panah untuk melihat promo lainnya.
                  </p>
                ) : null}
              </div>
            </div>
        ...
        {/* Layanan */}
        <section className="py-24 bg-surface-container-low" id="layanan">
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-surface-container-lowest p-4 sm:p-8 rounded-3xl group hover:scale-[1.03] transition-all duration-300">
        ...
        <section className="py-24 bg-surface-container-low" id="harga">
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            {/* Header intro - redesain */}
            <div className="max-w-2xl mx-auto mb-16">
              <div className="rounded-2xl bg-surface-container-lowest border border-outline-variant/20 p-8 lg:p-10 text-center shadow-sm">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-surface-container-lowest p-4 sm:p-8 rounded-3xl group hover:scale-[1.03] transition-all duration-300">
                ...
                <ul className="space-y-2 text-sm text-on-surface-variant">
                  <li className="flex justify-between gap-3"><span>Daily Cleaning</span><span className="font-extrabold text-secondary shrink-0">Rp 75rb</span></li>
                  <li className="flex justify-between gap-3"><span>Salon Kamar Mandi</span><span className="font-extrabold text-secondary shrink-0">Rp 250rb–400rb</span></li>
                  <li className="flex justify-between gap-3"><span>Torrent Kecil</span><span className="font-extrabold text-secondary shrink-0">Rp 200rb</span></li>
                  <li className="flex justify-between gap-3"><span>Torrent Sedang</span><span className="font-extrabold text-secondary shrink-0">Rp 250rb</span></li>
                  <li className="flex justify-between gap-3"><span>Torrent Besar</span><span className="font-extrabold text-secondary shrink-0">Rp 350rb</span></li>
                  <li className="flex justify-between gap-3"><span>Cuci AC</span><span className="font-extrabold text-secondary shrink-0">Rp 85rb</span></li>
                  <li className="flex justify-between gap-3"><span>Karpet Kantor / m</span><span className="font-extrabold text-secondary shrink-0">Rp 20rb</span></li>
                  <li className="flex justify-between gap-3"><span>Karpet Masjid / m</span><span className="font-extrabold text-secondary shrink-0">Rp 20rb</span></li>
                  <li className="flex justify-between gap-3"><span>Potong Rumput / m</span><span className="font-extrabold text-secondary shrink-0">Rp 10rb–50rb</span></li>
                </ul>
              </div>
              ...
              <div className="bg-surface-container-lowest p-4 sm:p-8 rounded-3xl group hover:scale-[1.03] transition-all duration-300">
                ...
                <ul className="space-y-2 text-sm text-on-surface-variant">
                  <li className="flex justify-between gap-3"><span>Sofa / Seat</span><span className="font-extrabold text-secondary shrink-0">Rp 65rb</span></li>
                  <li className="flex justify-between gap-3"><span>Sofa Bed Jumbo</span><span className="font-extrabold text-secondary shrink-0">Rp 200rb</span></li>
                  <li className="flex justify-between gap-3"><span>Sofa Bed Sedang</span><span className="font-extrabold text-secondary shrink-0">Rp 150rb</span></li>
                  <li className="flex justify-between gap-3"><span>Kursi Kantor</span><span className="font-extrabold text-secondary shrink-0">Rp 30rb</span></li>
                  <li className="flex justify-between gap-3"><span>Kursi Makan</span><span className="font-extrabold text-secondary shrink-0">Rp 25rb</span></li>
                  <li className="flex justify-between gap-3"><span>Bantal Sofa</span><span className="font-extrabold text-secondary shrink-0">Rp 15rb</span></li>
                </ul>
              </div>
              ...
              <div className="bg-surface-container-lowest p-4 sm:p-8 rounded-3xl group hover:scale-[1.03] transition-all duration-300">
                ...
                <ul className="space-y-2 text-sm text-on-surface-variant">
                  <li className="flex justify-between gap-3"><span>200 × 200</span><span className="font-extrabold text-secondary shrink-0">Rp 300rb</span></li>
                  <li className="flex justify-between gap-3"><span>180 × 200</span><span className="font-extrabold text-secondary shrink-0">Rp 250rb</span></li>
                  <li className="flex justify-between gap-3"><span>160 × 200</span><span className="font-extrabold text-secondary shrink-0">Rp 200rb</span></li>
                  <li className="flex justify-between gap-3"><span>120 × 200</span><span className="font-extrabold text-secondary shrink-0">Rp 180rb</span></li>
                  <li className="flex justify-between gap-3"><span>90 × 200</span><span className="font-extrabold text-secondary shrink-0">Rp 150rb</span></li>
                  <li className="flex justify-between gap-3"><span>Bahan Latex</span><span className="font-extrabold text-secondary shrink-0">+Rp 25rb</span></li>
                  <li className="flex justify-between gap-3"><span>Springbed Sorong 120×200</span><span className="font-extrabold text-secondary shrink-0">Rp 350rb</span></li>
                  <li className="flex justify-between gap-3"><span>Springbed Sorong 90×200</span><span className="font-extrabold text-secondary shrink-0">Rp 300rb</span></li>
                  <li className="flex justify-between gap-3"><span>Springbed Anak</span><span className="font-extrabold text-secondary shrink-0">Rp 150rb</span></li>
                  <li className="flex justify-between gap-3"><span>Dipan</span><span className="font-extrabold text-secondary shrink-0">Rp 150rb</span></li>
                  <li className="flex justify-between gap-3"><span>Bantal / Guling</span><span className="font-extrabold text-secondary shrink-0">Rp 20rb</span></li>
                </ul>
              </div>

              {/* Mobil & Baby - baris kedua, di tengah seperti Layanan */}
              <div className="bg-surface-container-lowest p-4 sm:p-8 rounded-3xl group hover:scale-[1.03] transition-all duration-300 md:col-start-2">
                <div className="w-16 h-16 rounded-2xl bg-primary/5 text-primary flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-on-primary transition-colors">
                ...
                <ul className="space-y-2 text-sm text-on-surface-variant">
                  <li className="flex justify-between gap-3"><span>Jok Mobil / Seat</span><span className="font-extrabold text-secondary shrink-0">Rp 65rb</span></li>
                  <li className="flex justify-between gap-3"><span>Interior Mobil</span><span className="font-extrabold text-secondary shrink-0">Rp 75rb–150rb</span></li>
                  <li className="flex justify-between gap-3"><span>Carseat</span><span className="font-extrabold text-secondary shrink-0">Rp 135rb</span></li>
                  <li className="flex justify-between gap-3"><span>Stroller</span><span className="font-extrabold text-secondary shrink-0">Rp 150rb</span></li>
                </ul>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h2 className="text-3xl lg:text-4xl font-extrabold mb-12 font-headline">Cara Kerja</h2>
        ...
        {/* Kenapa Kami */}
        <section className="py-24 bg-primary text-on-primary overflow-hidden relative" id="kenapa-kami">
        ...
        <section className="py-20 bg-surface">
          <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center gap-12 opacity-40 grayscale">
              <div className="flex items-center gap-2 font-headline font-black text-2xl">
                <Icon name="apartment" />
                Kencana Residensi
              </div>
              <div className="flex items-center gap-2 font-headline font-black text-2xl">
        ...
        <section className="py-24 px-6">
          <div className="max-w-5xl mx-auto bg-gradient-to-r from-secondary to-primary rounded-[3rem] p-12 lg:p-20 text-center text-on-primary relative overflow-hidden">
            <div
            ...
            />
            <div className="relative z-10">
              <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 font-headline">
                Siap untuk Hidup Lebih Praktis?
              </h2>
              <p className="text-xl mb-10 text-on-primary/90 max-w-xl mx-auto">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-block bg-surface-container-lowest text-primary px-12 py-5 rounded-2xl font-black text-xl shadow-2xl transition-transform ${
                  waDigits ? 'hover:scale-105' : 'pointer-events-none opacity-50'
                }`}
                aria-disabled={!waDigits}
              >
      ...
      <footer className="bg-surface-container-low pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 border-b border-outline-variant/30 pb-16 grid md:grid-cols-4 gap-12">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-on-surface-variant gap-4">
          <p>
