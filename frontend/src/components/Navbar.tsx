...
const TITLE_BY_PATH: Record<string, string> = {
  ...
  [`${DASHBOARD_BASE}/reports`]: 'Rekapan Laporan',
        ...
        <div className="flex min-w-0 items-center gap-2">
          {onOpenMobileNav ? (
            <button
              ...
              className="material-symbols-outlined flex h-11 w-11 shrink-0 items-center justify-center rounded-lg text-on-surface hover:bg-surface-container-high md:hidden"
