...
export default function Login() {
  ...
  return (
    <ClickSpark
      ...
      sparkCount={8}
      duration={400}
      className="login-page flex min-h-screen min-h-[100dvh] w-full min-w-0 flex-col items-center justify-center overflow-y-auto overflow-x-clip bg-surface p-4 font-body text-on-surface antialiased h-auto sm:p-6 sm:py-8 lg:p-12"
    >
      <div className="flex w-full min-w-0 max-w-[1200px] flex-1 flex-col overflow-x-clip overflow-y-visible py-4 lg:flex-row lg:rounded-xl lg:bg-surface-container-low">
